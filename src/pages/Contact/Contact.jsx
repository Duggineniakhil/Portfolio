...
export default function Contact() {
  ...
  return (
    <main
      className="pt-20 lg:pt-[0rem] bg-transparent
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">duggineniakhil15@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Rajampet, Andhra Pradesh, India</p>
                  </div>
                </div>
              </div>
            </div>
